...
public:
  ...
  /// Check if the Semantic can be expressed with a scale
  ...
  unsigned getIntegralBits() const {
    return Width + LsbWeight - hasSignOrPaddingBit();
  }
...
/// JTC1 SC22 WG14 N1169. The class carries info about the fixed point type's
/// width, sign, lsb_weight, and saturation, and provides different operations
/// that would normally be performed on fixed point types.
class APFixedPoint {
public:
